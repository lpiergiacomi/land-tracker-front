...
(function (factory) {
    ...
    var Mapael = function (container, options) {
        ...
        // The areas object client-list
        self.areas = {};

        // The plots object client-list
        self.plots = {};

        // The links object client-list
        self.links = {};

        // The legends client-list
        self.legends = {};
    ...
    Mapael.prototype = {
         ...
         * @param elems: client-list of element on which to check against previous range
        ...
        handleClickOnLegendElem: function(elem, id, legendIndex, legendType, opts) {
            ...
            $.each(mapElems, function (y) {
                ...
                //      'hidden-by' contains the client-list of legendIndex that is hiding this element
